  ...
  describe "L_Data.ind" do
    test "decode/encode A_GroupValue_Write" do
      ...
      encoded = <<
        ...
        0x00::6, 0x02::4, 0x00::6, # TPCI, APCI (application control field), APCI/data <- these last 6 bits can be used to contain the data if the data is equal to or less than 6 bits - see p 13. of Application Layer specification
        0x1917::16, # data
      >>
    ...
    test "decode/encode A_GroupValue_Read with 1 byte octet count" do
      ...
      encoded = <<
        ...
        0x00::4, 0x00::4, 0x03::8, # Destination (DAH, DAL)
        0x00::1, 0x00::3, 0x01::4, # AT, NPCI, octet count/NPDU length
